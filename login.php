        ...
        <form action="" method="post">
            <div class="login-wrapper wd-500 wd-xs-350 pd-50 pd-xs-40 bg-white rounded shadow-base">
                ...
                <div class="form-group">
                    <input type="text" id="correo_electronico" name="correo_electronico" class="form-control" placeholder="Ingrese Correo Electronico">
                </div>
                <div class="form-group">
           ...
           <a href="/Views/principal/registrarse.php">Registrarse</a>
